...
from dle_rae_bot.utils.html import get_unwrapped_content


class HttpDefinitionRepository:

    def get_definitions(self, word=None, url=None) -> Optional[WordDefinition]:
